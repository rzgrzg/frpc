...
RUN tar -zxf frp_${FRP_VERSION}_linux_amd64.tar.gz  --strip-components=1  frp_${FRP_VERSION}_linux_amd64/frpc -C /var/frp \  
    && tar -zxf frp_${FRP_VERSION}_linux_amd64.tar.gz  --strip-components=1  frp_${FRP_VERSION}_linux_amd64/frpc.ini -C /var/frp/conf \  
